function Plot_Traces_Map(nFile)
% plot factors with convex hull but excluding circles of inactive neurons
addpath('../Func');
setDir;
...
video          = VideoWriter([PlotDir '\movie_' dataset{nFile}, '.avi'], 'Uncompressed AVI');
video.FrameRate = 10;
open(video);
