...
% Trace similarity calculated on inter-event interval distribution
% Product of ks density
% -------------------------------------------------------------------------
% Yinan Wan
% wany@janelia.hhmi.org
%
function [totalFactor, followerNonActive, tagList, simIEIList] = Leader_v4_2_1(nFile)
...
%     
    ...
    subplot(2, 2, [1, 2]);
    title(titleText);
    setPrint(20, 15, [newPlotDir  'InitialLeaderPairs_IEI_' fileName '_Factor' num2str(nFactor)], 'pdf');
