...
%     % remove this==== % FACluster_v0_8(nFile, nTime) % plot CorrSpace (time snap for 1_2, 1_3 plots) 
...
%     % remove this==== % FACluster_v1_4(nFile) % plot FA size against time (duplicated with 1_1)
